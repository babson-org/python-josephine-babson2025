...
Josephine, I liked what you did with this lab. You use
3 loops in the text_anaysis() problem which could be
replaced with 1 if, elif, elif block

In caesar, move your print result out the loop.
That way it only prints out the final message.
